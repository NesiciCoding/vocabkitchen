...
- **`--cando-off`** — the Phase 4 Can-Do framing: express the text's demands as
...
| `--cando-off`           | express the text's demands as CEFR global-scale Can-Do descriptors (what a learner at the reached/estimated band can do) |
